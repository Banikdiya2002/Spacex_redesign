...
(function(){
  ...
  let socials=document.querySelectorAll('.social div'); //it contains arr type
  socials.forEach(function(it,indx) {
     it.style.animation=`moveIn .6s cubic-bezier(.51,.92,.24,1.15) forwards ${indx/7+.2}s`
  });
}())
